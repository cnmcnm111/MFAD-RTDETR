...
def get_params():
    params = {
        'weight': '/home/zxw/Desktop/MFAD-RTDETR/runs/train/MFAD-RTDETR/weights/best.pt',
        'device': 'cuda:0',
        'method': 'LayerCAM',
        'layer': [22],
        'backward_type': 'all',
        'conf_threshold': 0.502,
        'ratio': 0.01,
        'show_box': True,
        'renormalize': False
    }
...
if __name__ == '__main__':
    ...
    model(r'/home/zxw/Desktop/MFAD-RTDETR/PCB-1386/images/test/09_missing_hole_06.jpg', 'result')